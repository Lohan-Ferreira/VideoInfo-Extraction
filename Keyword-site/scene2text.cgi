...
palavrinha = s.getWordStem("extremidade")
...
if(already == 0):
	...
	tfidf_vectorizer = TfidfVectorizer(max_features=10000,stop_words = stopwordsen)
...
<head><title>Sample CGI Script</title>
  <meta charset="UTF-8">
...
""" % (message_words_list,keyword,dicts,inicio_cena,keyword))
